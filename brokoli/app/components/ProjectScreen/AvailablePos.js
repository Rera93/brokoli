...
export default class Bookmarks extends React.Component{
    ...
    componentDidMount(){
        ...
        this.state.projectTitle = this.props.navigation.state.params.selectedItem.title
        this.setState(function(prevState, props){
             return { projectTitle: prevState.projectTitle }
        })
    ...
    _fetchCorrenspondingProject(){
                ...
                /*
                    Store the array as the state of posData define above.
